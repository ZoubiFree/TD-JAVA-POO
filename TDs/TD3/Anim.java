...
public class Anim {
	...
	/// Question qui tue : 0 robots crees.
	System.out.println ("Nombre de robots deja crees : " + Robot.robotsCrees()) ;

	/// TD3 : le numero de serie n'est plus passe au constructeur. Les robots ont un nom.
