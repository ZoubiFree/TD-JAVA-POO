...
public class Robot {
    ...
    /// TD3: compteur statique du nombre de robots crees
    private static int nbRobots = 0 ;

    /// TD3: compteur statique du nombre d'explosions
    ...
    /// TD3: question qui tue : Getter statique du nombre de robots crees
	...
	if (this.vivant && autre.vivant && (autre != this) && enCollision) {
		...
		/// TD3 : affichage d'un message à chaque collision
		System.out.println("Collision entre " + this + " et " + autre) ;
	    }
	}
    }

    /// TD3 : redéfinition de toString
    ...
    /// TD3: ne plus exploser apres un certain seuil.
    public void explose() {
